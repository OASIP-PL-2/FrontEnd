<script setup>
import { ref, onMounted, computed, onUpdated, onBeforeMount } from "vue";
...
const addEventToDB = async (newEvent) => {
  ...
  // console.log(errorBookingName.value);
  // console.log(errorBookingEmail.value);
  // console.log(errorEventNote.value);
  // console.log(validateEventStartTime.value);
  // console.log(validateCategoryId.value);
