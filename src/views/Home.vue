            ...
            <div class="grid grid-cols-3 gap-4 px-6 mx-auto mt-8 md:flex md:-mx-4" >
              ...
              <div v-for="(category,index) in categories" :key="index">
                <router-link :to="{ name: 'ShowEvent' , params: { time: category.eventCategoryName }}" >
                    <div class="w-full h-64 overflow-hidden bg-center bg-cover rounded-md md:mx-4 md:w-1/2" style="background-image: url('https://kinsta.com/wp-content/uploads/2021/11/back-end-developer-1024x512.png')">
