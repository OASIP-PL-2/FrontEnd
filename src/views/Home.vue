    ...
    <div class="container" style="padding-top: 31px;">
        <div class="row">
            <div class="col-md-5 col-lg-4 col-xl-5 offset-xl-0 align-self-center ps-lg-0 pe-lg-0 me-lg-0">
                ...
                <div></div><router-link :to="{ name: 'Appointment' }"><button class="btn btn-primary d-md-flex d-lg-flex d-xl-flex mt-lg-3 ms-lg-3" type="button" style="background: rgb(82,108,147);border-color: rgb(82,108,147);border-top-color: rgb(255,;border-right-color: 255,;border-bottom-color: 255);border-left-color: 255,;">Booking Now</button></router-link>
            </div>
